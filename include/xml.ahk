...
class xml
{
	...
	*/
	...
	searchElementByAttribute(node, attribute) {
		Loop % this.getLength(node, "element")
		{
			n := this.getChild(node, "element", A_Index)
			If (n.getAttribute("attribute") == attribute) {
				Return n
			}
		}
